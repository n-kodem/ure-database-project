...
erDiagram
    ...
    concession_fuel ||..o|  concession_expiry : places
    concession_other_fuel ||..o|  concession_expiry : places
    concession_fuel ||--o| concession_promise : contains
    concession_other_fuel ||--o| concession_promise : contains
```
